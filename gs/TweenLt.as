...
package gs {
	...
	import flash.utils.*;
/**
 * 	TweenLt is a super-lightweight (1.6k in AS3 and 1.85k in AS2) version of <a href="http://www.TweenLite.com">TweenLite</a> 
 ...
 *  I chose the name "TweenLt" to convey the idea that it is basically "TweenLite" with some stuff missing. TweenLt can do 
 *  everything TweenLite can do with the following exceptions:
 * 	<ul>
