package com.xmaser.mouse {
	...
	public class MouseRightMenu extends EventDispatcher{
		...
		public function MouseRightMenu(roo:InteractiveObject) {
		 ...
		 */
		public function addItem(str:String, func:Function=null,separatorBefore:Boolean=false,enabled:Boolean=true):void
		{
			//removeItem(str);			
		...
		//禁用
		public function disabledItem(adminindex:int):void
		{
			menu.customItems[adminindex].enabled=false
		}
		public function enabledItem(adminindex:int):void
		{
			menu.customItems[adminindex].enabled=true
		}
