package cn.hcxmflash.control.pageControl 
{
	...
	public class PageControlMc extends MovieClip
	{
		...
		public function get nowP():int
		{
			return _nowP;
		}
		private var _started:Boolean=false;
		protected function __btn_pCLICK(e:MouseEvent):void 
		{
		...
		protected function __btn_nCLICK(e:MouseEvent):void 
		{
		...
		public static const  PAGEEVENT:String="pageEvent";
		...
		protected function __btn_prevCLICK(e:MouseEvent):void 
		{
			nowPage--;
			if (nowPage<1) 
			{
		...
		protected function __btn_nextCLICK(e:MouseEvent):void 
		{
			nowPage++;
		...
		{
			dispatchEvent(new Event_(PAGEEVENT,nowPage))
