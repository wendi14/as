package com.xmaser.events 
{
	 ...
	 * @author 小火柴
	 */
	public class HCEvent extends Event
	{
		public var data:*;
		...
		public function HCEvent(type:String,data:*=null,bubbles:Boolean=false,cancelable:Boolean=false) 
		{
		...
		{
			return new HCEvent(type,data,bubbles,cancelable)
		}
	}
